...
namespace WindowsFormsApplication1
{
	public class Form1 : Form
	{
		...
		{
			Assembly executingAssembly = Assembly.GetExecutingAssembly();
			Stream manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.Alien2.png");
			Image image = Image.FromStream(manifestResourceStream);
			int num = junkie.Next(1200);
			int num2 = junkie.Next(900);
			double num3 = 3.0;
			for (int i = 0; i < 12; i++)
			{
